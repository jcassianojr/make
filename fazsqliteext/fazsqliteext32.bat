...
echo [1/3] Configurando ambiente MSVC (32-bit)...
...
set OUT_DIR=c:\temp\sqlite\bin\extensions32

if not exist "%OUT_DIR%" mkdir "%OUT_DIR%"

echo [3/3] Compilando as extensoes para 32-bit...
...
echo Concluido com sucesso! 32-bit gerado em: %OUT_DIR%
pause